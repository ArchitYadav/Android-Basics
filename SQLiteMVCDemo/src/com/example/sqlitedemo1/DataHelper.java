...
public class DataHelper extends SQLiteOpenHelper
{
	...
	public static final String DBName = "OfficeDB";
	...
	{
		String q = "create table employee(eid integer,name text,salary real,deptId integer)";
		db.execSQL(q);
		String iql = "insert into employee values(1,'Raj',45000,1)";
		db.execSQL(iql);
		String iql1 = "insert into employee values(10,'Archit',65000,3)";
		db.execSQL(iql1);
		String iql2 = "insert into employee values(34,'Divya',55000,2)";
		db.execSQL(iql2);
		
		q = "create table department(deptid integer,name text)";
		db.execSQL(q);
